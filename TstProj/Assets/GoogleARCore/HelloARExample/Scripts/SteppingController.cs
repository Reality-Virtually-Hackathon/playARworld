...
namespace GoogleARCore.HelloAR
{
    ...
    /// </summary>
    public class SteppingController : MonoBehaviour
    {
        /// <summary>
        ...
        public void Update()
        {
            ...
            if (questionObject == null)
            {
                ...
                var anchor = Session.CreateAnchor(m_firstPersonCamera.transform.position, m_firstPersonCamera.transform.rotation);
            ...
            questionObject.transform.position = Vector3.Slerp(questionObject.transform.position, qPanelPos + m_firstPersonCamera.transform.position, 0.5f);
