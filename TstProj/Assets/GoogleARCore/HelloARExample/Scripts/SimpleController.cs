        ...
        public void Update()
        {
            ...
            if (Session.Raycast(m_firstPersonCamera.ScreenPointToRay(touch.position), raycastFilter, out hit))
            {
                ...
                if (GameObject.Find("Andy") == null)
                {
                    ...
                    andyObject.name = "Andy";
                }
                else
                {

                    var andyObject = GameObject.Find("Andy");
                    Vector3 andyPos = m_firstPersonCamera.WorldToScreenPoint(andyObject.transform.position);

                    if (touch.position.x < andyPos.x + 200 && touch.position.x > andyPos.x - 200)
                    {
                        if (touch.position.y < andyPos.y + 200 && touch.position.y > andyPos.y - 200)
                        {
                            //removes
                            Destroy(andyObject);
                            return;
                    ...
                    // moves
                    andyObject.transform.position = hit.Point;
                    andyObject.transform.LookAt(m_firstPersonCamera.transform);
                    andyObject.transform.rotation = Quaternion.Euler(0.0f,
                        andyObject.transform.rotation.eulerAngles.y, andyObject.transform.rotation.z);
                }
