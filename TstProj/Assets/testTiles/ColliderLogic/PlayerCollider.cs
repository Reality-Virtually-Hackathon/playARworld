...
public class PlayerCollider : MonoBehaviour {
	...
	void Start () {
        ...
        playerColGo.transform.localScale = Vector3.one * 999f;//.5f; 
	...
	void Update () {
		...
		var newScale = new Vector3 (playerColGo.transform.localScale.x, distance, playerColGo.transform.localScale.z);
